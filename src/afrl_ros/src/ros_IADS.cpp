...
int main(int argc, char **argv) 
{
    ...
    while (ros::ok())
    {
        ...
        iads.setParameter(IADS__AIRSPEED, uas_info.vfr[1])
            .setParameter(IADS__ALTITUDE, uas_info.vfr[2])
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0]) // lat
            .setParameter(IADS__PITCH, uas_info.attitude_deg[1]) // long
            ...
            .setParameter(IADS__ROLL_RATE, uas_info.attitude_rate_deg[0])
            .setParameter(IADS__PITCH_RATE, uas_info.attitude_rate_deg[1])
            .setParameter(IADS__YAW_RATE, uas_info.attitude_rate_deg[2])
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0]) // xacc
            .setParameter(IADS__PITCH, uas_info.attitude_deg[1]) //y acc
            .setParameter(IADS__HEADING, uas_info.vfr[0]) // z acc
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0]) // aileron
            .setParameter(IADS__PITCH, uas_info.attitude_deg[1]) // elevator
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0]) // rudder
            .setParameter(IADS__PITCH, uas_info.attitude_deg[1])
            .setParameter(IADS__HEADING, uas_info.vfr[0])
            .setParameter(IADS__ROLL_RATE, uas_info.attitude_rate_deg[0])
            .setParameter(IADS__PITCH_RATE, uas_info.attitude_rate_deg[1])
            .setParameter(IADS__YAW_RATE, uas_info.attitude_rate_deg[2])
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0]) // extra
            .setParameter(IADS__PITCH, uas_info.attitude_deg[1]) //extra 
            .setParameter(IADS__HEADING, uas_info.vfr[0])
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0]) // lat
            .setParameter(IADS__PITCH, uas_info.attitude_deg[1]) // long
            .setParameter(IADS__ROLL, uas_info.attitude_deg[0])
